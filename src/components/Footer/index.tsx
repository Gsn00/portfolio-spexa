export default function Footer() {
  return (
    <footer className="border-t border-white/10 py-12 mt-20 text-secondary">
      <div className="max-w-300 mx-auto px-6 grid grid-cols-1 md:grid-cols-3 place-items-center gap-8">
